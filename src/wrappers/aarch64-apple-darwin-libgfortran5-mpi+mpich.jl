...
function __init__()
    JLLWrappers.@generate_init_header(OpenBLAS32_jll, SuperLU_DIST_jll, MUMPS_jll, HDF5_jll, Triangle_jll, TetGen_jll, SCALAPACK32_jll, METIS_jll, SCOTCH_jll, PARMETIS_jll, MPICH_jll, MPIPreferences)
