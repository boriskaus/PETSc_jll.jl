...
function __init__()
    JLLWrappers.@generate_init_header(libblastrampoline_jll, CompilerSupportLibraries_jll, SCALAPACK32_jll, METIS_jll, SCOTCH_jll, PARMETIS_jll, MicrosoftMPI_jll, MPIPreferences)
